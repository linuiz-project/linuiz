use crate::mem::{hhdm::HigherHalfDirectMap, pmm::PhysicalMemoryManager};
...
unsafe impl core::alloc::GlobalAlloc for KernelAllocator {
        ...
        match alloc_result {
            Ok(frame_address) => {
                ...
                core::ptr::without_provenance_mut(
                    HigherHalfDirectMap::frame_to_page(frame_address)
                        .get()
                        .get(),
                )
            }
    ...
    unsafe fn dealloc(&self, ptr: *mut u8, layout: Layout) {
        ...
        let physical_offset = HigherHalfDirectMap::negative_offset(ptr.addr()).get();
